...
public class BundlesTabUi extends Composite implements Tab {
	...
	private void startSelectedBundle() {
		...
		this.securityTokenService.generateSecurityToken(new AsyncCallback<GwtXSRFToken>() {
			...
			public void onSuccess(GwtXSRFToken token) {
				BundlesTabUi.this.deviceService.startBundle(
	...
	private void stopSelectedBundle() {
		...
		this.securityTokenService.generateSecurityToken(new AsyncCallback<GwtXSRFToken>() {
			...
			@Override
			public void onSuccess(GwtXSRFToken token) {
				BundlesTabUi.this.deviceService.stopBundle(BundlesTabUi.this.selectionModel.getSelectedObject().getId(),
	...
	public void refresh() {
		...
		this.gwtXSRFService.generateSecurityToken(new AsyncCallback<GwtXSRFToken>() {
			...
			@Override
			public void onSuccess(GwtXSRFToken token) {
				BundlesTabUi.this.gwtDeviceService.findBundles(new AsyncCallback<ArrayList<GwtGroupedNVPair>>() {
